...
from MergeModels import LMMerger
...
argparser.add_argument("--models_to_merge", type=str, nargs="+", default="WizardLMTeam/WizardLM-13B-V1.2,vanillaOVO/WizardMath-13B-V1.0,layoric/llama-2-13b-code-alpaca", help="Models to merge. Default: WizardLMTeam/WizardLM-13B-V1.2,vanillaOVO/WizardMath-13B-V1.0,layoric/llama-2-13b-code-alpaca")
...
merger = LMMerger(merge_method = merge_method, base_model = base_model, models_to_merge = args.models_to_merge, save_path = args.save_path)
merger()
